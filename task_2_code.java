...
class BallThread extends Thread {
    ...
    public BallThread(Ball ball, BallCanvas canvas, Runnable onPocket) {
        this.b = ball;
        this.canvas = canvas;
...
class BounceFrame extends JFrame {
    ...
    private BallCanvas canvas;
    private JTextField fieldPocketed; // текстове поле для лічильника
    private int pocketedCount = 0;    // лічильник кульок у лузі
    ...
    public BounceFrame() {
        ...
        // Показує кількість кульок у лузі
        ...
        buttonStart.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                canvas.add(b);
                BallThread thread = new BallThread(b, canvas, new Runnable() {
                    @Override
                    public void run() {
                        // Оновлення лічильнику в потоці подій
